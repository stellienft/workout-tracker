      ...
      <div className="flex min-h-dvh">
        <aside className="hidden w-60 shrink-0 flex-col border-r border-[var(--border-subtle)] bg-[var(--background-secondary)] md:flex">
          ...
          <div className="mt-auto border-t border-[var(--border-subtle)] p-3">
            <Link
              href="/dashboard"
              className="flex items-center gap-2 rounded-xl px-3 py-2 text-sm text-[var(--text-secondary)] hover:text-white"
            >
              <ArrowLeft className="h-4 w-4" /> Back to app
            </Link>
            <form action={signOut}>
              <button className="flex w-full items-center gap-2 rounded-xl px-3 py-2 text-sm text-[var(--text-secondary)] hover:text-white">
        ...
        <main className="min-w-0 flex-1">
          <div className="border-b border-[var(--border-subtle)] px-4 py-3 md:hidden">
            <div className="flex items-center justify-between">
              <p className="font-bold">
                Stellio <span className="text-[var(--accent-primary)]">Admin</span>
              </p>
              <Link href="/dashboard" className="text-sm text-[var(--text-secondary)]">
                Exit
              </Link>
            </div>
