            ...
            <div className="mt-6 flex flex-col gap-3">
              {billingReady ? (
                <UpgradeButton
                  ...
                  className="inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-[var(--accent-primary)] px-5 py-3.5 font-semibold text-black disabled:opacity-60 sm:w-auto sm:px-8"
                />
              ) : (
