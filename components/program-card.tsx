...
export function ProgramCard({
  ...
  return (
    <Link
      ...
      className="group block overflow-hidden rounded-[var(--radius-card)] border border-[var(--border-subtle)] bg-[var(--surface-primary)] transition-transform active:scale-[0.99]"
    >
